...
function studioPublishErrorLabel(code) {
  const labels = {
    ...
    discord_role_ping_failed: "Discord refused the standalone role notification. Check the publication webhook and try again.",
    discord_role_ping_not_recognized: "Discord did not recognize the role notification. Make the role mentionable, then try again.",
