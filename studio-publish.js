...
function studioPublishErrorLabel(code) {
  const labels = {
    ...
    discord_role_ping_failed: "The bot could not send the role notification. Check its Send Messages and Mention Everyone permissions in this channel.",
    discord_role_ping_not_recognized: "Discord did not recognize the role notification. Make the role mentionable or give the bot permission to mention roles, then try again.",
